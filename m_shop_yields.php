...
//show yield name typing in input or if it is null show list name
	...
	function new_yield_step_two()
		...
		if(yield_type_data=document.getElementById("yield_type_data").value)
			{
				 turn_json();
				 allData.append('y_image[1]',document.getElementById('y_image_1').files[0]);
				 allData.append('y_image[2]',document.getElementById('y_image_2').files[0]);
				 allData.append('y_image[3]',document.getElementById('y_image_3').files[0]);
...
<div id="content_center" style="padding-top:70px;">
...
<div id="left_all">
<div id="product_title"><img src="http://www.yeroks.com/img_files/list.png" />Reyon Listesi</div>	
<div id="rayon">
<?php
