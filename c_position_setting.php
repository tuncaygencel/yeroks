...
<link href="css/shop_setting.css" type="text/css" rel="stylesheet" />
...
function save_shop_center_pos()
		...
		var floor=document.getElementById('selected_floor').value;
			$.ajax({
					type:'POST',
					url:'http://www.yeroks.com/aj_pos/shop_set_center.php',	
					dataType: 'json',					
...
<a href="http://www.yeroks.com/position_setting.php" id="set_button" class="pos_set_button"  style="border-bottom:1px solid red;"  >
Konum Ayarları
</a>
<a href="http://www.yeroks.com/image_setting.php"  id="set_button" class="img_set_button">
