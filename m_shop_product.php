...
if(isset($_GET['s_no']) and isset($_GET['c_no']))
	...
	if($error==0)
	{
	$connect->enter_active(6,1,$c_id,$s_id,0);
?>
<html>
<head>
<title> <?php
...
if($check_type->latitude!='0' and $check_type->longitude!='0' )
	...
	function add_fav()
				...
				if(fav_busy==0){
				fav_busy=1;
					$('#add_fav').html('<img height="16" src="img_files/cycle_loading.gif"/>');
					$.ajax({
					type:'POST',
	...
	function open_big_image()
			...
			$('#black_background').css('display','block');
			$('#light_box_area').css('display','block');
			$('#light_box_area').html("<div onclick=\"hidebackground()\" id=\"search_text_box_exit\"></div><img src=\"https://www.yeroks.com/s_profile_img_big/"+p_image+"\"/>");
			}
...
<div id="help_info_area">
 2016 © Yeroks İstanbul 
<div style="margin-top:20px;"> <a href="https://www.yeroks.com/shop_index.php">Mağaza Girişi</a><a href="https://www.yeroks.com/about.php">Hakkımızda</a><a href="https://www.yeroks.com/product_list.php">Ürün Çeşitleri</a>
</div>
</div>
</div>
</div>
