...
$t_no;
	...
	$connect->enter_active(8,1,0,0,$place_id);
	$place->get_place_img();
?>
<html>
<head>
...
<link href="https://www.yeroks.com/css/m_place.css" type="text/css" rel="stylesheet" />
<script>
...
////route functions
		...
		{
		 $('#example_products').animate( { scrollLeft: '+=100' }, 100);
		return false;
		}
	...
	function bottom_scroll()
		...
		function open_big_image()
			...
			$('#black_background').css('display','block');
			$('#light_box_area').css('display','block');
			$('#light_box_area').html("<div onclick=\"hidebackground()\" id=\"search_text_box_exit\"></div><img src=\"https://www.yeroks.com/p_img_big/"+p_image+"\"/>");
			}
</script>
</head>
<body>
...
<div id="place_info">
<div id="place_image" <?php if(array_key_exists( 1, $place->place_img)){ echo " onclick=\"open_big_image()\" style=\"background-image:url('p_img_big/".$place->place_img[1]."');\" >"; }else{ echo "><img style=\"    margin-top: 60px;margin-left: 45px;\" height=120 src=\"https://www.yeroks.com/img_files/place_icon.png\"/>";} ?> </div>
<div id="place_images">
<?php
...
<div id="exp_yields">
<div id="exp_y_title"><?php echo $place->name; ?>'nin Bazı Ürünleri </div>
<div id="exp_pro_center">
...
<select id="y_exp_input" onchange="get_exp_yields(3)">
...
<div id="events_area">
<div id="show_area">
<div id="product_title"><img src="https://www.yeroks.com/img_files/list.png"/> <?php echo $place->name."'deki Mağazalar"; ?></div>
	<div id="s_result"></div>
