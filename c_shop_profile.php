...
var yield_name='';
	...
	function add_rayon(y_data){
		$('#yield_search_result').html("");
		$('#rayon_add_result').html('<img style="margin-top:74px;" height=40 src="img_files/cycle_loading.gif"/>');
		...
		$.ajax({
					...
					success: function(info) {
						if(info.error==0){
							...
							$('#rayon_add_result').html("<div id=\"y_image\"><img src=\"https://www.yeroks.com/y_img_small/"+info.icon+".png\" height=\"100\"></div><b>"+info.name+"</b> Reyonunuz Reyon Listesinde Oluşturuldu.Reyonunuzun içine "+info.name+" çeşitlerinizi ekleyebilirsiniz...");
							}else{
							alert(info.exp);
							$('#rayon_add_result').html('');
							}
...
<body>
<div id="black_background1" style="display:none;">
</div>
<div id="light_box_area1" style="display:none;">
</div>
<div id="small_banner">
...
<div id="left_content">
 <div id="loader_img" style="padding:20px;text-align:center;display:none;background-color:white;font-size:30px;color:black;font-weight:bold;margin-bottom:10px;margin-top:40px;margin: 40px auto 0px 200px;position: absolute;z-index: 99;">
 Yükleniyor...<br>
 <img src="img_files/cycle_loading.gif" height="100" style="margin-top: 20px;"></div>
<div id="loader_background" style="position: absolute;height: 100%;width: 650px;background-color: rgb(60, 60, 60); z-index: 95;opacity: 0.6;display: none;">
</div>
<div id="events_area">
<div id="rayon">
<?php
